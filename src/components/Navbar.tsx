...
export default function Navbar() {
  return (
    <div className="Navbar">
      <Link to="/"></Link>
      <Link to="/pages/sign_up.tsx"></Link>
      <Link to="/pages/sign_in.tsx"></Link>    
    ...
    <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div className="flex items-center lg:order-2">
            ...
            <a href="https://themesberg.com/product/tailwind-css/landing-page"
                className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Mon Espace Santé</a>
